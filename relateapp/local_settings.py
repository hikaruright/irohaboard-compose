...
RELATE_BASE_URL = "https://training.solxyz.app"
...
RELATE_CUTOMIZED_SITE_NAME = "学習サイト"
...
EMAIL_HOST = 'www2296.sakura.ne.jp'
EMAIL_HOST_USER = 'no-reply@solxyz.info'
EMAIL_HOST_PASSWORD = 'ittl@dm1n'
EMAIL_PORT = 587
EMAIL_USE_TLS = True

ROBOT_EMAIL_FROM = "Administrator <no-reply@solxyz.info>"
RELATE_ADMIN_EMAIL_LOCALE = "ja_JP"

SERVER_EMAIL = ROBOT_EMAIL_FROM

ADMINS = (
    ("Administrator", "no-reply@solxyz.info"),
    )
